...
public class SearchIndex {
    ...
    public SearchIndex(String indexPath, String scoringApproach, String chosenAnalyzer, String stopwordsPath) {
        ...
        documentCategoryScores.put("Content", 3.5f);
    ...
    public void searchQueryFile(String queriesFile, String output) {
        try {
            this.analyzer = new CranfieldAnalyzer(chosenAnalyzer, stopwordsPath).getAnalyzer();
